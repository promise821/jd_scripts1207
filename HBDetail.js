...
!(async () => {
    ...
    let isServerKey = $.isNode() ? process.env.PUSH_PLUS_TOKEN != '' : false;
    if ($.isNode()) {
        if (notifyLevel == 0) {
...
function cal(data, nickName) {
    ...
    for (var i = 0; i < hbs.length; i++) {
        ...
        //计算各平台总额
        res = calHB(orgLimitStr, hb, jx, jd, js);
        jx = res.jx;
        jd = res.jd;
        js = res.js;
    ...
    subHB = add(add(jd, jx), js);
    let pushOverviewNotify = '';
    let pushDetailNotify = '';
    //push+支持空行，其他则用文字
    if ($.isNode() && process.env.PUSH_PLUS_TOKEN != '') {
        pushOverviewNotify += '<style>table,th,tr,td{border:1px solid#0094ff}table{width:100%;min-height:25px;line-height:25px;text-align:center;border-collapse:collapse;padding:2px}</style><table><tr><th colspan="2"style="color: red;">' + nickName + '</th></tr><tr><td>总额</td><td>' + subHB + '</td></tr><tr><td>今过期</td><td>' + expiresToDay + '</td></tr><tr><td>明过期</td><td>' + expiresTomorrow + '</td></tr><tr><td>后过期</td><td>' + expiresDAT + '</td></tr></table>';

        pushDetailNotify += '<table><tr><th colspan="2"style="color: red;">' + nickName + '</th></tr><tr><th colspan="2">红包总额</th></tr><tr><td colspan="2">' + subHB + '</td></tr><th colspan="2">各平台金额详情</th><tr><td>京东红包总额</td><td>' + jd + '</td></tr><tr><td>京喜红包总额</td><td>' + jx + '</td></tr><tr><td>极速红包总额</td><td>' + js + '</td></tr></table><br><table><tr><th colspan="2">今天过期总金额</th></tr><tr><td colspan="2">' + expiresToDay + '</td></tr><th colspan="2">各平台今天过期详情</th><tr><td>京东</td><td>' + expiresToDayJD + '</td></tr><tr><td>京喜</td><td>' + expiresToDayJX + '</td></tr><tr><td>极速</td><td>' + expiresToDayJS + '</td></tr></table><br><table><tr><th colspan="2">明天过期总金额</th></tr><tr><td colspan="2">' + expiresTomorrow + '</td></tr><th colspan="2">各平台明天过期详情</th><tr><td>京东</td><td>' + expiresTomorrowJD + '</td></tr><tr><td>京喜</td><td>' + expiresTomorrowJX + '</td></tr><tr><td>极速</td><td>' + expiresTomorrowJS + '</td></tr></table><br><table><tr><th colspan="2">后天过期总金额</th></tr><tr><td colspan="2">' + expiresDAT + '</td></tr><th colspan="2">各平台后天过期详情</th><tr><td>京东</td><td>' + expiresDATJD + '</td></tr><tr><td>京喜</td><td>' + expiresDATJX + '</td></tr><tr><td>极速</td><td>' + expiresDATJS + '</td></tr></table><br><br>';
        return {
            pushOverviewNotify,
            pushDetailNotify
        }
        ...
        pushDetailNotify += lineFeed + (($.isNode() ? process.env.PUSH_PLUS_TOKEN != '' : false) ? ('▶▶▶▶▶▶▶▶▶▶▶▶▶▶▶▶▶▶▶▶' + lineFeed) : lineFeed);
    }
    return {
        pushOverviewNotify,
        pushDetailNotify
...
function calHB(orgLimitStr, hb, jx, jd, js) {
    ...
    } else if (contain(orgLimitStr, '极速')) {
        js = add(hb.balance, js);
    }
    return {
        jx,
        jd,
