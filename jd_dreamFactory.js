...
async function joinLeaderTuan() {
  ...
  $.tuanIdS = null;
  if (!$.tuanIdS) await updateTuanIdsCDN('https://raw.githubusercontent.com/nbzongzong/Actions/main/jd_updateFactoryTuanId.json');
  if ($.tuanIdS && $.tuanIdS.tuanIds) {
    for (let tuanId of $.tuanIdS.tuanIds) {
      if (!tuanId) continue
      await JoinTuan(tuanId);
...
function updateTuanIds(url = 'https://raw.githubusercontent.com/nbzongzong/Actions/main/jd_updateFactoryTuanId.json') {
  return new Promise(resolve => {
...
function updateTuanIdsCDN(url = 'https://raw.githubusercontent.com/nbzongzong/Actions/main/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    $.get({url,
      headers:{
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://raw.githubusercontent.com/nbzongzong/Actions/main/jd_updateFactoryTuanId.json');
