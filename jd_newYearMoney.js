...
const inviteCodes = [
  `IzCejUrleQH4T659N_w8s3mRP_hwimLni1XoYT0@oMZeXeBI9YNUAuM3P7J2-emg_aTP20ruUQEmjDTln_y7R2SD@oMZeXecc9YwGUeA4N7QjqfIkm0t5ogoZJONO7e41_pXuF_7O@oMZeL4w78tMSZZtYYfQXsz01-pGu4DrwWDu1UdrX1dqP1fI`
];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
          ...
          if (data && data.data['bizCode'] === 0) {
            ...
            if (info) {
              ...
              if (sendAccount.includes($.index.toString())) {
				  //送卡等级>4
                let cardList = $.cardList.filter(vo => vo.cardType > 3 & vo.cardType !==7)
