...
let scoreToBeans = $.isNode()?(process.env.JD_IMMORTAL_SCORE || 100):$.getdata('scoreToBeans') || 700; //兑换多少数量的京豆（20或者1000），0表示不兑换，默认兑换20京豆，如需兑换把0改成20或者1000，或者'商品名称'(商品名称放到单引号内)即可
...
const inviteCodes = [
  `32xIs4YwE5Z7Dr96QZnoInEQ1X8hlPrQEGTdZZYmRoExWFYqA`,
  `32xIs4YwE5Z7Dr96QZnoInEQ1X8hlPrQEGTdZZYmRoExWFYqA`
];
!(async () => {
  await requireConfig();
