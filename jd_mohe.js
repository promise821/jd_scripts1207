...
!(async () => {
  ...
  await $.http.get({url: `https://code.c-hiang.cn//api/v1/jd/mohe/read/2`, timeout: 10000}).then(async (resp) => {
...
function updateShareCodesCDN(url = 'https://raw.githubusercontent.com/nbzongzong/updateTeam/master/shareCodes/jd_shareCodes.json') {
  return new Promise(resolve => {
    $.get({
      url ,
      timeout: 10000,
