    ...
    return new Promise(async _0x47f940 => {
        ...
        if(abcde == 0){
            ...
            if (_0x59bbb8 && _0x59bbb8['code'] === 0xc8) {
                inviteCodes = [...new Set([...$[_0x551f('164', 'EKqs')], ..._0x59bbb8[_0x551f('165', 'qXlN')] || []])]
            }
        }
