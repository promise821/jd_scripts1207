...
//邀请码可能一天一变化，先测试
$.shareId = ["4e17ba5f-f810-4083-a957-6cce6ba693d8","7d97213f-6c09-473c-a81c-3b9de2f7edba"];
!(async () => {
  if (!cookiesArr[0]) {
  ...
  await $.http.get({url: `https://code.chiang.fun//api/v1/jd/mohe/read/5`, timeout: 10000}).then(async (resp) => {
